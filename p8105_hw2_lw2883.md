...
```
  ...
  - Of the stations that serve the A train, **15** are ADA compliant.
...
unemployment.csv.
  ...
  - “pols-month” had data on the number of politicians that were
    ...
    representatives, and presidents. There were **817 rows** and **9
    columns**.
...
datasets: pols-month, snp, and unemployment. This data has **817 rows**
