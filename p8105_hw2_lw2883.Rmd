...
Separate 'mon' variable into 'year', 'month', 'day'; create a 'president' variable from the 'prez_dem' and 'prez-gop' variables and remove 'day' variable.
...
* "pols-month" had data on the number of politicians that were democratic or republican from 1947-2015. It contained the date (year and month), the number of republican and democatic senators, representatives, and presidents. There were **`r nrow(pols_df)` rows** and **`r ncol(pols_df)` columns**. 
